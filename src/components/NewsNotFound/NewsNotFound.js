...
<section className="news-not-found">
  <div className="news-not-found__no-match">
    ...
    <p className="news-not-found__text">К сожалению по вашему запросу<br/>
    ничего не найдено.</p>
  </div>
  <p className="news-not-found__error" >Во время запроса произошла ошибка. Возможно, проблема с соединением или сервер недоступен. Подождите немного и попробуйте ещё раз.</p>
</section>
  );
}
