...
<header className={className}>
  <div className="header__border-mobile">
    <div className="header__menu">
      ...
      <img onClick={() =>  setMenuActiv(!menuActiv)} className="header__image" src={menuActiv  ? cross : `${theme === "_white" ? menuBlack : menuWhite}`} alt="закрыть меню"></img>
    </div>
  </div >
  <Navigation theme={theme} loggedIn={loggedIn} onAuth={onAuth} menuActiv={menuActiv}/>
</header>
  );
}
